...
```{r}
#| label: rstudio-ide-cut_1
#| fig-width: 1
#| fig-height: 1
include_local_figure("Printscreens/RStudio_IDE_screenshot-cut_1.png")
```
...
```{r}
#| label: rstudio-ide-cut_2
#| fig-width: 1
#| fig-height: 1
include_local_figure("Printscreens/RStudio_IDE_screenshot-cut_2.png")
```
...
```{r}
#| label: rstudio-ide-cut_3
#| fig-width: 1
#| fig-height: 1
include_local_figure("Printscreens/RStudio_IDE_screenshot-cut_3.png")
```
...
```{r}
#| label: rstudio-ide-cut_4
#| fig-width: 1
#| fig-height: 1
include_local_figure("Printscreens/RStudio_IDE_screenshot-cut_4.png")
```
